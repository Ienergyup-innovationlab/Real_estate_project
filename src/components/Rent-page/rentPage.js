      ...
      <div className=" container mx-auto md:mt-20 mt-10">
        <div className=" bg-buybg h-[428px] md:h-[650px] md:w-full flex flex-col items-center justify-center">
          <h1 className="  selection:font-semibold text-center text-lg md:text-5xl text-white">
            {" "}
            Rent Your Apartment With Confidence
          </h1>
        ...
        <div className="md:h-[496px] flex-col-reverse flex md:flex-row justify-center items-center md:mt-48 md:mr-32 md:ml-32">
            <div className="w-[343px] md:w-[558px] md:ml-4 md:mb-84 mt-16">
                ...
                <div className="items-center">
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex justify-around ml-[0.4rem] mb-[0.25rem]">
                        ...
                        <p className="font-semibold text-[1.45rem] mb-[0.95rem] mt-[0.35rem]">
                        N999,000.00
                        </p>
                        <div className="flex justify-between w-[16rem] text-center">
            ...
            <div className="w-[343px] md:w-[558px] md:ml-4 md:mb-84 mt-16">
                ...
                <div className="items-center">
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex justify-between justify-center w-[16rem]">
                        <button className="border-2 border-amber-300 bg-inherit p-[0.35rem] w-[7.5rem] rounded-lg font-semibold">
                            More
                        </button>
                        <button className="border-2 bg-amber-400 p-[0.35rem] w-[7.5rem] rounded-lg font-semibold">
        ...
        <div className=" flex flex-col justify-center items-center mt-10 md:mt-64 w-full">
