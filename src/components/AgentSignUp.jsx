    ...
    <div>
      ...
      <div className="m-auto w-full p-2 flex flex-col place-items-center">
        <div className="h-fit w-[22rem] mb-[3.5rem] rounded-md border-black border-0 grid grid-cols-4 divide-x-2 md:w-[30rem] md:h-[3.2rem]">
          ...
          <button className="font-semibold rounded-lg bg-amber-500 border-black border-2" onClick={()=>{setSignUpForm("Agent")}}>
            Agent
          </button>
          <button className="font-semibold rounded-lg border-2 border-black" onClick={()=>{setSignUpForm("Agent")}}>
            House Owner
          </button>
        </div>
        <div>
