  ...
  return (
    <>
      ...
      <div className="bg-Buybg w-full h-[22rem] p-[1rem] bg-cover -mb-[0.45rem] flex flex-col place-items-center justify-center">
        <h1 className="text-white font-bold text-[2.25rem] mb-[0.3rem]">
        ...
        <div className="py-[2.5rem] px-[1.8rem] -mb-[4rem]">
          <div className="w-full h-[18rem] shadow-lg rounded-xl p-[1.4rem] pl-[2.5rem] pt-[5rem] border-2 border-gray-100 flex justify-between">
            <div className="w-[20.5rem] -mt-[2.15rem] h-[13.3rem]">
              <div>
                <img
                  className="mb-[0.8rem] rounded-lg h-[13.05rem] w-full cursor-pointer"
                  src={Houses}
                  alt="Agent"
                />
              </div>
            ...
            <div className="flex flex-col justify-center">
              <h1 className="text-xl font-semibold -mt-[3.85rem] mb-[0.7rem] cursor-pointer">
                4 Bedroom Bungalow
              </h1>
              <div>
                <div>
      ...
      <div className="px-[3.25rem] pb-[3rem]">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col justify-center relative left-[3.25rem] p-[0.5rem] place-items-center">
            ...
            <p className="text-[0.55rem] w-[12rem]">
              Stay up to date with our latest news and update
            </p>
            <div className="mx-[5rem]">
              <form action="">
                <input className="hidden border-2" type="text" />
                <button className="border-2 bg-inherit font-semibold p-[0.4rem] w-[14rem] rounded-md">
                  Email
                </button>
              </form>
            </div>
      ...
      <Carousel
        ...
        autoPlay={true}
        autoPlaySpeed={2200}
        className="p-[1.5rem] mb-[1.125rem]"
      >
        <div>
